...
// Static content (can later be replaced with API data)
const aboutContent = {
	heading: "Our World of Beauty",
	paragraph:
		"Welcome to our salon! We provide professional beauty and wellness services tailored to your needs. Our team of experts ensures every visit leaves you looking and feeling your best.",
	stats: [
			...
			<div className="relative z-10 max-w-7xl mx-auto px-6">
				<div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2">
					...
					<div className="order-2 lg:order-1">
						...
						>
							{aboutContent.heading || "Our World of Beauty"}
						</motion.h2>
						...
						>
							{aboutContent.paragraph ||
								"Welcome to our salon! We provide professional beauty and wellness services tailored to your needs."}
						</motion.p>
					...
					>
						<div className="w-full h-96 relative rounded-xl overflow-hidden shadow-2xl">
							<img
								...
								alt={
									aboutContent.image?.alt || "Salon Interior"
								}
