...
const services = [
  {
    id: 1,
    title: "Hair Cutting",
    description: "Professional hair cutting and styling tailored to your look.",
    price: 500,
    duration: "45 min",
  ...
  },
  {
    id: 3,
    title: "Manicure",
    description: "Pamper your hands with our professional manicure service.",
    price: 700,
    duration: "40 min",
    imageUrl: "/assets/salonhero.jpeg",
    icon: "FaHandSparkles",
  ...
  useEffect(() => {
    const updateSlides = () => {
      if (window.innerWidth < 768) {
        ...
        setSlidesPerView(2); // 💻 Desktop → 2 cards
      }
    };
